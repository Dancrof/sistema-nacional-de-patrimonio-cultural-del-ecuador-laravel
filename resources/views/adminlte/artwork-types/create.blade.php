...
@section('title', 'Nuevo tipo de obra')

@section('content_header')
    <div class="row">
        <div class="col-sm-6">
            <h1 class="m-0">Nuevo tipo de obra</h1>
        </div>
        <div class="col-sm-6">
...
@section('content')
    <x-adminlte-card icon="bi bi-palette-fill" title="Nuevo tipo de obra">
        <form method="POST" action="{{ route('adminlte.artwork-types.store') }}">
            @csrf
